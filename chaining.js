...
// All of the strings on one line...
var chainingResult = integers.sort(function(a,b){return b-a}).filter(function(num){return num < 19}).map(function(x){return (x * 1.5) - 1}).reduce(function (a,b){return a + b});
